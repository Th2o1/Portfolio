      ...
      <div className="card w-[420px]">
        ...
        <div className="flex flex-row flex-wrap gap-y-5 gap-x-2 items-start justify-center ">
          {items.map((item, idx) => (
            <div
              key={idx}
              className="flex items-center gap-2 bg-secondary rounded-4xl p-3 min-w-[120px] max-w-[40%] h-[76px] "
            >
              <div className="w-[42px] h-[50px] flex items-center justify-center">
                {item.icon}
              </div>
              <div className="flex flex-col items-start justify-center max-w-2/5">
